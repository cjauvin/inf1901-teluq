...
* Il est possible de mesurer la **distance** qui sépare deux objets (en se basant sur les caractéristiques); cette distance peut être vue aussi comme une mesure de _similarité_, à quel point les deux objets sont semblables
