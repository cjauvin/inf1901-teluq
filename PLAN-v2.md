...
**État au 2026-09-13** : arbre de travail **propre**, tout commité et poussé sur `v2`. Christian a relu jusqu’à *Prédire par ressemblance* inclus et attaque *Un modèle qui s’entraîne* ; restent ensuite *Classer*, *Généraliser*, *Trois façons d’apprendre*. **Ensuite, prochaine action inchangée** : la **régularisation** dans *Généraliser* (3ᵉ volet du triptyque), puis la page « Bien évaluer un modèle ».
