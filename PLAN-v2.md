...
- ***Capturer l'expertise*** 🟡 (passe faite, relecture de Christian à venir) : tirets 48 → 8 ; lien Module 2 vers « Sous les modèles, des probabilités » ; **applet du moteur d'inférence** (`moteur-inference.html`, chaînage avant pas à pas, hauteur 640).
- ⬜ Restent : ***Les hivers et la bascule*** (49 tirets ; contient le web sémantique ajouté et Watson), le **travail noté 1** (20 tirets), l'**accueil** du M1.
