...
**État au 2026-09-13** : arbre de travail **propre**, tout commité et poussé sur `v2`. Christian a terminé la relecture de *Regarder les données* et attaque *Prédire par ressemblance* ; restent ensuite *Un modèle qui s’entraîne*, *Classer*, *Généraliser*, *Trois façons d’apprendre*. **Ensuite, prochaine action inchangée** : la **régularisation** dans *Généraliser* (3ᵉ volet du triptyque), puis la page « Bien évaluer un modèle ».
