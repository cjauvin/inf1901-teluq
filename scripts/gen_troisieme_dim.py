...
ZH = 168.0                 # hauteur entre le barreau du bas et celui du haut
...
def rendre(nom, barreaux, desc, legende):
    """barreaux : ((0, étiquette, sous-étiquette ou None), (1, …))."""
    L = []
...
rendre(
    "troisieme-dimension-oui-non",
    ((0, "non", None), (1, "oui", None)),
    "Une vue en perspective. Le plan horizontal porte les deux mêmes axes qu'auparavant : la distance au "
    "centre et l'année de construction. La réponse à la question « vendue en moins de 30 jours ? » occupe "
