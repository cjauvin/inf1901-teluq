...
AUTRES = [(160, 220), (145, 240), (172, 202)]
...
o.append('<g fill="#8c8175">')
for x, y in AUTRES:
    o.append(f'<circle cx="{x}" cy="{y}" r="4"/>')
o.append('</g>')

# vignette
o.append(f'<rect x="{VX}" y="{VY}" width="{VW}" height="{VH}" fill="#fbf7ee" stroke="#b8a888" stroke-width="1"/>')
...
o.append(f'<rect x="{PX}" y="{PY}" width="{PW}" height="{PH}" rx="4" fill="#fbf7ee" stroke="#b8a888" stroke-width="1"/>')
...
o.append('<text x="330" y="380">Le courriel entier est un seul point de cet espace ; les points gris sont d\'autres courriels.</text>')
o.append('<text x="330" y="400">Un axe par mot du vocabulaire, donc des dizaines de milliers d\'axes.</text>')
o.append('</g>')
o.append('</svg>')
